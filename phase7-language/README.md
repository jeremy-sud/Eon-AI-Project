...
Exploración en Models de Lenguaje Minimalistas utilizando la arquitectura Eón (ESN). Contrario a los Transformers, TinyLM busca eficiencia extrema y entrenamiento en el dispositivo.
...
- **Diccionario Trie Ultra-Lightweight**:
  - Implementación personalizada basada en arrays planos (LCRS).
  - Reduce el uso of memory del vocabulario en >50% comparado con listas estándar (en C).
...
- `src/trie_vocab.py`: Structure de datos Trie eficiente.
